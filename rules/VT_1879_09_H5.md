# Rules for the table [VT_1879_09_H5](https://github.com/cgueret/DataDump/blob/master/xls-marked/VT_1879_09_H5_marked.xls?raw=true)
## Row properties
...
| grieken >> grieken >> grieken >> grieken >> v | Assign the code "sex-V" to the dimension "sex" *and* Assign the code "belief-97" to the dimension "belief" *and* Assign the code "belief-97" to the dimension "belief" *and* Assign the code "belief-97" to the dimension "belief" *and* Assign the code "belief-97" to the dimension "belief" |
