# Rules for the table [BRT_1889_12_T1](https://github.com/cgueret/DataDump/blob/master/xls-marked/BRT_1889_12_T1_marked.xls?raw=true)
## Row properties
...
| 25 --- 35 1864 --- 1854 >> v >> o >> 27 | Assign the code "marital-NotMarried" to the dimension "maritalStatus" *and* Assign the code "sex-V" to the dimension "sex" |
