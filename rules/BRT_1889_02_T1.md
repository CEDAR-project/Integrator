# Rules for the table [BRT_1889_02_T1](https://github.com/cgueret/DataDump/blob/master/xls-marked/BRT_1889_02_T1_marked.xls?raw=true)
## Row properties
...
| van onbekenden leeftijd >> v >> g >> 50 | Assign the code "sex-V" to the dimension "sex" <br/> Assign the code "marital-Married" to the dimension "maritalStatus" |
