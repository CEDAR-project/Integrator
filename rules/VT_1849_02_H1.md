# Rules for the table [VT_1849_02_H1](https://github.com/cgueret/DataDump/blob/master/xls-marked/VT_1849_02_H1_marked.xls?raw=true)
## Row properties
| Title of the property | Rules |
| --------------------- |:-----:|
| GEMEENTEN | Assign a value from the "city" codes |
| PLAATSELIJKE INDEELING (wijken, dorpen etc.) | Assign a value from the "occupation" codes |
## Column properties
